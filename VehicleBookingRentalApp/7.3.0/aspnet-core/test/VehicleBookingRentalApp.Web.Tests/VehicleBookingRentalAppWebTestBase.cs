...
{
    public abstract class VehicleBookingRentalAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VehicleBookingRentalAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VehicleBookingRentalAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VehicleBookingRentalAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VehicleBookingRentalAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VehicleBookingRentalAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VehicleBookingRentalAppDbContext, Task<T>> func)
        {
            T result;

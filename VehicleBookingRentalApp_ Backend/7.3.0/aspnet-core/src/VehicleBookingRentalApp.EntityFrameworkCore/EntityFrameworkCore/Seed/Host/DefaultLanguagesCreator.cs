...
namespace VehicleBookingRentalApp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = VehicleBookingRentalAppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VehicleBookingRentalAppDbContext context)
        {
            _context = context;
        }
